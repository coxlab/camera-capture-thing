...
from SubpixelStarburstFeatureFinder import *
...
class PipelinedWorkerProcessManager(SyncManager):
    ...
    #CompositeFeatureFinder_ = CreatorMethod(CompositeFeatureFinder)
    #FastRadialFeatureFinder_ = CreatorMethod(FastRadialFeatureFinder)
    #StarBurstFeatureFinder_ = CreatorMethod(SubpixelStarburstFeatureFinder)
...
PipelinedWorkerProcessManager.register('FrugalCompositeFeatureFinder', FrugalCompositeFeatureFinder)
PipelinedWorkerProcessManager.register('FastRadialFeatureFinder', FastRadialFeatureFinder)
PipelinedWorkerProcessManager.register('StarBurstFeatureFinder', SubpixelStarburstFeatureFinder)
